...
export default function Header() {
  ...
  const desktopNavLinkClasses = ({ isActive }: { isActive: boolean }) =>
    cn(
      'group relative inline-flex snap-start flex-shrink-0 items-center gap-2 whitespace-nowrap rounded-lg px-3 py-2 text-sm font-medium transition-colors',
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-background/80 backdrop-blur-md shadow-card">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between gap-3">
            <div className="flex min-w-0 flex-1 items-center gap-6">
              ...
              <nav className="hidden min-w-0 max-w-full flex-1 lg:flex" aria-label="Primary navigation">
                <div className="flex min-w-0 items-center gap-4 overflow-x-auto whitespace-nowrap snap-x snap-mandatory [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
            ...
            <div className="flex flex-shrink-0 items-center gap-2 sm:gap-3">
              ...
              {user ? (
                <div className="flex flex-shrink-0 items-center gap-2">
                  <Badge variant="outline" className="hidden items-center gap-1.5 md:inline-flex">
